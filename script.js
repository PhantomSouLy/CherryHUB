...
function setThemeButton() { const btn = $("#themeToggle"); if (!btn) return; btn.textContent = root.dataset.theme === "light" ? "☀️ Light mode" : "🌙 Dark mode"; btn.setAttribute("aria-label", root.dataset.theme === "light" ? "Light mód aktív, váltás dark módra" : "Dark mód aktív, váltás light módra") }
